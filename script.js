...
document.addEventListener('DOMContentLoaded', function() {
    initContent();
    checkUK(); // Проверяем страну при загрузке
    
    // Добавляем обработчики событий
    document.querySelector('.tab[data-tab="main"]').addEventListener('click', () => showTab('main'));
    document.querySelector('.game-button').addEventListener('click', openGameModal);
